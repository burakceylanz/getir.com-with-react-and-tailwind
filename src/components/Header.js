    ...
    <div className='bg-brand-color'>
      <div className='container mx-auto h-16 md:h-11 flex items-center justify-center md:justify-between'>
        ...
        <nav className='hidden md:flex  gap-x-8  text-sm font-semibold'>
          <a href="#." className='flex gap-2 item-center  text-white transition-all text-opacity-80 hover:text-opacity-100'>
           <FiGlobe size={20}/>
            Türkçe (TR)
          </a>
          <a href="#." className='flex gap-2 item-center font-semibold text-white transition-all text-opacity-80 hover:text-opacity-100'>
           <FaUser size={20}/> Giriş Yap
          </a>
          <a href="#." className='flex gap-2 item-center font-semibold text-white transition-all text-opacity-80 hover:text-opacity-100'>
           <HiUserAdd size={20}/> Kayıt Ol
          </a>
        </nav>
      </div>
    </div>

    <div className='container mx-auto flex items-center h-10  px-3 justify-between'>
      <div className='flex items gap-x-2 text-sm font-normal text-gray-700'>
